...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_directional(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, MO(1),KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT
      ),
  ...
  LAYOUT_directional(
      ...
      ______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, LCTL(LSFT(KC_PSCREEN)), KC_PSCREEN , ______, KC_MS_WH_UP, ______,
      ______, BL_TOGG, BL_STEP, BL_INC, BL_DEC, ______, ______, ______, ______, ______, KC_MS_WH_DOWN, ______,
      ______, KC_VOLU, KC_VOLD, KC_MUTE, KC_BRIU, KC_BRID , ______, ______, ______, ______, ______, ______, ______, KC_PGUP, KC_INSERT,
